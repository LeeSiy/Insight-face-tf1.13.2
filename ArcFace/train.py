...
#------------------------------------------------------------
summary = SummaryWriter('/home/sylee/log')
count = 0
count2 = 0
count3 = 0
model_num = 0
...
def train_net(args):
    ...
    prefix = os.path.join(args.models_root,
                          '%s-%s-%s' % (args.network, model_num, args.dataset),
                          'model')
    ...
    def ver_test(nbatch):
        ...
        for i in range(len(ver_list)):
            ...
            if ver_name_list[i]=='agedb_30':
                summary.add_scalar('Test/agedb_30', acc2, count)
                count += 1
            elif ver_name_list[i]=='lfw':
                summary.add_scalar('Test/lfw', acc2, count)
                count2 += 1
            else:
                summary.add_scalar('Test/cfp_fp', acc2, count)
                count3 += 1
            results.append(acc2)
        return results
